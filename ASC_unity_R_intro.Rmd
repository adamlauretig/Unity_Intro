...
Under `#COMMANDS TO RUN`, `source /opt/intel/bin/compilervars.sh intel64` calls the necessary intel compiler, and `/usr/local/R/3.3.2/bin/Rscript` is the path for the `Rscript` command, to batch execute the script.  Just using `module load intel R`
